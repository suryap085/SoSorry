...
public class PlaylistCardAdapter extends RecyclerView.Adapter<PlaylistCardAdapter.ViewHolder> {
    ...
    public void onBindViewHolder(final ViewHolder holder, final int position) {
        ...
        holder.mViewCountText.setText(sFormatter.format(videoStatistics.getViewCount()==null ? BigDecimal.ZERO:videoStatistics.getViewCount()));
        holder.mLikeCountText.setText(sFormatter.format(videoStatistics.getLikeCount()==null ? BigDecimal.ZERO:videoStatistics.getLikeCount()));
        holder.mDislikeCountText.setText(sFormatter.format(videoStatistics.getDislikeCount()==null ? BigDecimal.ZERO:videoStatistics.getDislikeCount()));
